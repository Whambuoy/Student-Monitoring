...
class AfricasTalkingGatewayException extends Exception  {
    //TODO: Introduce exception catch
    //        Log::info("SMS account: ".$this->_username." called.");
}
class AfricasTalkingGateway extends Facade
{
    protected $_username;
    protected $_apiKey;
    ...
    {
        $username_ = client_app()->af_talking_username; //"engeryx";
        $apiKey_ =  client_app()->af_talking_key;//"f27dcbf4d00a9206b56aeb0b6aa82f857e83444e45a025a10963751f30c37acc";
